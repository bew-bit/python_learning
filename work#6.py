...
class Stationary:
    ...
    def draw(self):
        return f'Начало рисования {self.title}'
...
class Pen(Stationary):
    ...
    def draw(self):
        return f'{self.title}. Начало рисования ручкой'
...
class Pencil(Stationary):
    ...
    def draw(self):
        return f'{self.title}. Начало рисования карандашом'
...
class Handle(Stationary):
    ...
    def draw(self):
        return f'{self.title}. Начало рисования маркером'
